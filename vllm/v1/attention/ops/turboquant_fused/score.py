...
Ports the 0xSero/turboquant score module with the key fix:
USE the fused Triton kernels instead of PyTorch dequantization.
"""
...
from turboquant_fused.store import FlatCache, CompressedKVStore
from turboquant_fused.kv_cache import dequantize_values
from turboquant_fused.quantizer import TurboQuantProd
...
def _matmul_attend(
    ...
    v = kv_values.float().unsqueeze(1) # (H_kv, 1, N, D)
